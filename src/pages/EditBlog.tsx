...
const EditBlogPostModal: React.FC<EditBlogPostModalProps> = ({ loading, isOpen, onClose, onSubmit, initialData }) => {
    ...
    >
      ...
      <form onSubmit={handleSubmit(onSubmitForm)} className="space-y-6">
        ...
        <div>
          ...
          <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
            <div className="text-center">
              {previewImage ? (
                <img src={previewImage} alt="Preview" className="mx-auto h-40 w-56 object-cover rounded-md" />
              ) : (
          ...
          {errors.image && <p className="text-red-500 text-sm mt-1">{errors.image.message as any}</p>}
        </div>
        <div className="flex justify-end">
          ...
          >
            {loading ? (
              <SyncLoader speedMultiplier={1} color='#ffffff' margin={1} size={5} />
            ) : "Update Post"}
          </button>
        </div>
      </form>
